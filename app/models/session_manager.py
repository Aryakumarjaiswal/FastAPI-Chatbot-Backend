...
from app.database import ChatRecord, SessionLocal
...
class SessionManager:
    ...
    #     phone_number=None,
    #     role=str,
    #     transfer_call_conversation=str
    # ):
...
def save_chat_record(
    ...
    phone_number=None,
    role=None,
    transfer_call_user_message=None,
    transfer_call_response=None
):
    db_record = ChatRecord(
        session_id=session_id,
        user_message=user_message,
        ...
        phone_number=phone_number,
        role=role,
        transfer_call_user_message=transfer_call_user_message,
        transfer_call_response=transfer_call_response,
    )
    db.add(db_record)
    db.commit()
    db.refresh(db_record)
